"""
This script allows users to define distributions for parameter soil texture (RF_TX).
See document `docs/rf_tx_Mapping_Documentation.md` in detail for current determined
midpoint values and ranges.

Customize the 'user_defined_rf_tx_distributions' dictionary to tailor it with your 
chosen distribution types and parameters.
...
output_path = os.path.join(
    dir_path, "..", "data", "params_sampling_range", "rf_tx_params_dist.json"
)
# Save to file
