...
class CropResidueAggregator:
    """
    A class to handle dictionary of array inputs for the CropResidueCalculator, allowing for analysis with changes in multiple nested parameters. Calculates variations for every parameter in the data automatically.
    ...
    baseline_data : dict
        The baseline data created by taking the first element of each numpy array in nested dictionaries.
